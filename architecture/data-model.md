...
├── current_step_id    (string, active step within workflow; null during divergence)
├── divergence_contexts (jsonb, nullable, divergence/convergence runtime state — see Divergence and Convergence §5.1)
